#
#  Be sure to run `pod spec lint FCVersionController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of FCVersionController in Markdown format.
  ...
  s.homepage     = "http://EXAMPLE/FCVersionController"
  ...
  s.source_files  = "FCVersionController", "FCVersionController/**/*.{h,m}"
